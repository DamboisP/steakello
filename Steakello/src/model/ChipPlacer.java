...
public class ChipPlacer {
	...
	/**
	 * Méthode checkIfFlips vérifie, dans chaque direction,
	 * s'il est possible de prendre/retourner certains jetons 
	 * appartenant à (de la couleur de) l'adversaire. 
	 * Cette méthode est une copie de checkForChipsToFlip qui ne modifie pas le tableau de jeu. 
	 * Elle a été rajoutée pour les cas où un joueur passe son tour (n'a plus de coups valides)
